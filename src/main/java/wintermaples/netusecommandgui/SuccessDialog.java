...
public class SuccessDialog extends javax.swing.JDialog {
  ...
  private void initComponents() {
    ...
    setIconImage(new javax.swing.ImageIcon(getClass().getResource("/2309.png")).getImage());
    setLocationByPlatform(true);

    jLabel1.setFont(new java.awt.Font("メイリオ", 0, 18)); // NOI18N
    jLabel1.setText("ログインに成功しました");

    jButton1.setFont(new java.awt.Font("メイリオ", 0, 12)); // NOI18N
    jButton1.setText("OK");
